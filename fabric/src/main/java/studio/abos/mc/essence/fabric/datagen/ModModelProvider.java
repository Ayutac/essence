package studio.abos.mc.essence.fabric.datagen;
...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateItemModels(ItemModelGenerators itemModelGenerator) {
        ...
        itemModelGenerator.generateFlatItem(ModItems.ESSENCE_SHIELD.asItem(), ModelTemplates.FLAT_HANDHELD_ITEM);
        itemModelGenerator.generateFlatItem(ModItems.ESSENCE_SHOVEL.asItem(), ModelTemplates.FLAT_HANDHELD_ITEM);
        itemModelGenerator.generateFlatItem(ModItems.ESSENCE_SPEAR.asItem(), ModelTemplates.FLAT_HANDHELD_ITEM);
